<div class="row g-1 mt-2">
                                        ...
                                        <div class="col mt-2">
                                            ...
                                            <?php if ($key['dokumentasi_50'] && !$key['dokumentasi_100'] && session()->get('role') != 2) { ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-2"><input type="submit" value="Update" class="btn btn-success tombol" style="font-size: 14px;margin-top: 10px;"></div>
                                                    <?= form_close(); ?>
                                                </div>
    ...
    <div class="row mt-2">
        <div class="col-12 d-flex justify-content-center">
            <?php
            echo ($open_count > 0) ? $pager_open->links('sipintas', 'bootstrap-pagination') : "";
            // echo $pager_open->links();
            // echo $pager_open->links('sipintas', 'bootstrap-pagination');
            ?>
        </div>
    </div>
</div>